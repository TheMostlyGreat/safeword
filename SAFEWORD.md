...
```markdown
### Planning Docs
- .agents/planning/user-stories/002-oauth-login.md
- .agents/planning/test-definitions/002-oauth-login.md
...
**Workflow:**
1. **Create ticket:** `.agents/tickets/{id}-{slug}.md`
...
9. **After confirmation:** Move to `.agents/tickets/completed/{id}-{slug}.md`
