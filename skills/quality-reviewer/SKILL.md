...
- **No AGENTS.md/CLAUDE.md**: Projects without context files (automatic hook won't run, manual review needed)
...
```bash
ls CLAUDE.md AGENTS.md ARCHITECTURE.md .claude/
```
...
**Project standards** (from CLAUDE.md/AGENTS.md/ARCHITECTURE.md):
...
4. **Projects without AGENTS.md** - Automatic hook won't run, you're the only quality check
