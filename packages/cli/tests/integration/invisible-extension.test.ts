...
`;
        ...
        const preservedConfig = readTestFile(
          projectDirectory,
          "eslint.config.mjs",
        );
        ...
        expect(
          fileExists(projectDirectory, ".safeword/eslint.config.mjs"),
        ).toBe(true);
        const safewordConfig = readTestFile(
          projectDirectory,
...
`;
        ...
        const preservedPyproject = readTestFile(
          projectDirectory,
          "pyproject.toml",
        );
...
`;
        ...
        expect(fileExists(projectDirectory, ".safeword/.golangci.yml")).toBe(
          true,
        );
        const safewordConfig = readTestFile(
          projectDirectory,
  ...
  describe("Hook Template", () => {
    it(
      ...
      async () => {
        ...
        expect(
          fileExists(projectDirectory, ".safeword/hooks/lib/lint.ts"),
        ).toBe(true);
        const lintHook = readTestFile(
          projectDirectory,
