...
describe('Test Suite: Conditional Setup for Go Projects', () => {
  describe('Test: Skips ESLint install for Go-only projects', () => {
    it('should not install eslint in node_modules for Go-only project', async () => {
  ...
  describe('Test: Skips package.json creation for Go-only', () => {
    it('should not create package.json for pure Go project', async () => {
      createGoProject(projectDirectory);
      initGitRepo(projectDirectory);
  ...
  describe('Test: Creates .golangci.yml for Go project', () => {
    it('should create golangci-lint config for Go project', async () => {
      createGoProject(projectDirectory);
      initGitRepo(projectDirectory);
  ...
  describe('Test: Shows Go-appropriate next steps', () => {
    it('should mention golangci-lint in output instead of npm/eslint', async () => {
      createGoProject(projectDirectory);
      initGitRepo(projectDirectory);
  ...
  describe('Test: Still creates .safeword directory', () => {
    it('should create .safeword with guides for Go project', async () => {
      createGoProject(projectDirectory);
      initGitRepo(projectDirectory);
  ...
  describe('Test: Still creates Claude hooks', () => {
    it('should create hooks for Go project', async () => {
      createGoProject(projectDirectory);
      initGitRepo(projectDirectory);
  ...
  describe('Test: Installs both toolchains for polyglot projects', () => {
    it('should configure ESLint AND create .golangci.yml for JS+Go project', async () => {
  ...
  describe('Test: Preserves existing .golangci.yml', () => {
    it('should not overwrite existing golangci-lint config', async () => {
      createGoProject(projectDirectory);
      initGitRepo(projectDirectory);
